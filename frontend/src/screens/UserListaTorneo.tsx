                    ...
                    <div className={styles.gridCards}>
                        {torneosFiltrados.map((torneo: TorneoDisponible) => (
                            ...
                            >
                                ...
                                <div
                                    className={`${styles.cardEstado} ${estadoClass(torneo.estado)}`}
                                >
                                    {formatearEstado(torneo.estado as EstadoTorneo)}
                                </div>
                                <button
                                    className={styles.inscribirseBtn}
                                    onClick={e => { e.stopPropagation(); alert("¡Inscripto! (falta conectar al back)"); }}
                                    disabled={torneo.estado !== "ABIERTO"}
                                    style={{ opacity: torneo.estado === "ABIERTO" ? 1 : 0.6, cursor: torneo.estado === "ABIERTO" ? "pointer" : "not-allowed" }}
                                >
                                    Inscribirse
                                </button>
                            </div>
