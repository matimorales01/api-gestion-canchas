...
import { CrearPartidoCerradoSchema } from "@/models/Partido";
...
export const CrearPartidoCerradoScreen = () => {
    ...
    const form = useAppForm({
        ...
        validators: {
            onChange: CrearPartidoCerradoSchema,
        },
        ...
        <CommonLayout>
            <AppForm>
                <FormContainer extraError={null}>
                    ...
                    <div>
                        <AppField name="equipo1" children={(field) => <field.TextField label="Equipo A" />} />
                        <AppField name="equipo2" children={(field) => <field.TextField label="Equipo B" />} />
